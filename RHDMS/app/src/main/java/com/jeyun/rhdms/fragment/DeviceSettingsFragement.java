...
import com.jeyun.rhdms.DeviceSettingsActivity;
...
public class DeviceSettingsFragement extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pillboxId = rootView.findViewById(R.id.pillbox_id);

        // Initialize EditTexts for time inputs
        alarmStartHour1st = rootView.findViewById(R.id.alarm_start_hour_1st);
        alarmStartMinute1st = rootView.findViewById(R.id.alarm_start_minute_1st);

        alarmStartHour2nd = rootView.findViewById(R.id.alarm_start_hour_2nd);
        alarmStartMinute2nd = rootView.findViewById(R.id.alarm_start_minute_2nd);

        alarmStartHour3rd = rootView.findViewById(R.id.alarm_start_hour_3rd);
        alarmStartMinute3rd = rootView.findViewById(R.id.alarm_start_minute_3rd);

        alarmDuration1st = rootView.findViewById(R.id.alarm1_running_time);
        alarmDuration2nd = rootView.findViewById(R.id.alarm2_running_time);
        alarmDuration3rd = rootView.findViewById(R.id.alarm3_running_time);

        settingnum = rootView.findViewById(R.id.settingnumber);

        SettingResetButton = rootView.findViewById(R.id.SettingReset_button);
        FactoryResetButton = rootView.findViewById(R.id.DeviceRest_button);

        volumeGroup = rootView.findViewById(R.id.volume_group);
    ...
    private JSONObject createSettingsJson() throws Exception {
        ...
        RadioButton selectedVolume = rootView.findViewById(selectedVolumeId);
